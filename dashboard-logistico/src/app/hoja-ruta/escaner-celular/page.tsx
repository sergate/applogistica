...
// Misma lógica de negocio que /hoja-ruta/escaner (handheld con lector
// físico), pero con captura por cámara para celulares Android sin
// accesorio -- ver CameraScanInput. Se mantienen como dos páginas
// separadas a propósito: el mecanismo de captura es tan distinto que
// comparte muy poco más allá de las llamadas a la API.
export default function EscanerCelularHojaDeRutaPage() {
