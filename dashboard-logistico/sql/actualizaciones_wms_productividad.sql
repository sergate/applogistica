-- Agrega "productividad" a las secciones válidas de actualizaciones_wms
-- (Producción por Proceso -> Importar Datos: actualización automática desde
-- el WMS vía Agente Local).
--
