...
-- Movimiento que exista entre "productos" y "varios", así los dos
-- comparten la misma secuencia y nunca se pisan. "control_calidad" queda
-- afuera de este cálculo a propósito -- tiene su propia nomenclatura, no
-- comparte numeración con productos/varios.
--
